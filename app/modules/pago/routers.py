...
from app.modules.pago.schemas import CrearPagoRequest, ConfirmarPagoRequest, PagoCrearResponse, PagoEstadoResponse
...
def confirm_payment(data: ConfirmarPagoRequest, svc: PagoService = Depends(get_payment_service),):
    return svc.confirmar_pago(data.pedido_id, data.mp_payment_id)
